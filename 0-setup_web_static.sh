...
echo "<html><head><title>Fake HTML file</title></head><body>This is a fake HTML file to test my Nginx configuration.</body></html>" | sudo tee /data/web_static/releases/test/index.html
